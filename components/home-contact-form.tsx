    ...
    <section id="contacto" className="py-20 md:py-28 bg-linear-to-br from-slate-950 via-slate-900 to-slate-800 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur-md p-8 md:p-10 rounded-3xl border-2 border-white/20 shadow-2xl hover:border-white/30 transition-colors">
          ...
          <div className="text-center mt-16">
            ...
            <Button size="lg" variant="outline" asChild className="bg-yellow-600/5 hover:bg-yellow-600/10 text-white border-2 border-yellow-600/60 hover:border-yellow-600 shadow-xl transition-colors px-10 py-7 font-semibold text-lg rounded-2xl">
